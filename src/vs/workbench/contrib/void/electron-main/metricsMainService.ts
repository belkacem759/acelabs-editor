...
export class MetricsMainService extends Disposable implements IMetricsService {
	...
	// helper - looks like this is stored in a .vscdb file in ~/Library/Application Support/AceLabs
	...
	async initialize() {
		...
		console.log('User is opted out of basic AceLabs metrics?', didOptOut)
		if (didOptOut) {
			this.client.optOut()
		}
		else {
		...
		console.log('AceLabs posthog metrics info:', JSON.stringify(identifyMessage, null, 2))
	}
