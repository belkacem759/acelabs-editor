...
// 		title:
// 			div
// 				"How would you like to use AceLabs?"
// 		content:
...
const VoidOnboardingContent = () => {
	...
	const lastPagePrevAndNextButtons = <div className="max-w-[600px] w-full mx-auto flex flex-col items-end">
		<div className="flex items-center gap-2">
			...
			>Enter the AceLabs</PrimaryActionButton>
		</div>
	</div>
		...
		0: <OnboardingPageShell
			content={
				<div className='flex flex-col items-center gap-8'>
					<div className="text-5xl font-light text-center">Welcome to AceLabs</div>

					{/* Slice of AceLabs image */}
